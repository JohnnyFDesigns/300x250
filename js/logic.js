	...
	function trackClick(){
        ...
        //Enabler.exit('300x250_exit'); // DC Studio
	}
	...
	function frame1Animation(){
		...
		TweenLite.set(".hand",{x:185, alpha:1})
		...
		TweenLite.to('.lid2',3,{rotation: 30, scale:0.8, transformOrigin: "100% 100%", x: 35, y: -220, ease: Power2.easeOut, delay:4.75});
		TweenLite.to('.hand',3,{rotation: 30, scale:0.8, transformOrigin: "100% 100%", x: 90, y: -160, ease: Power2.easeOut, delay:4.75});
